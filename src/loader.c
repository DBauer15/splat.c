...
loader_gsmodel_from_ply(const char *fn) {
    ...
    long num_x = ply_set_read_cb(ply, "vertex", "x", &loader_ply_read_callback, &read_payload, 0L);
    long num_y = ply_set_read_cb(ply, "vertex", "y", &loader_ply_read_callback, &read_payload, 1L);
    long num_z = ply_set_read_cb(ply, "vertex", "z", &loader_ply_read_callback, &read_payload, 2L);
    ply_set_read_cb(ply, "vertex", "f_dc_0", &loader_ply_read_callback, &read_payload, 3L);
    ply_set_read_cb(ply, "vertex", "f_dc_1", &loader_ply_read_callback, &read_payload, 4L);
    ply_set_read_cb(ply, "vertex", "f_dc_2", &loader_ply_read_callback, &read_payload, 5L);
    ply_set_read_cb(ply, "vertex", "scale_0", &loader_ply_read_callback, &read_payload, 6L);
    ply_set_read_cb(ply, "vertex", "scale_1", &loader_ply_read_callback, &read_payload, 7L);
    ply_set_read_cb(ply, "vertex", "scale_2", &loader_ply_read_callback, &read_payload, 8L);
    ply_set_read_cb(ply, "vertex", "rot_0", &loader_ply_read_callback, &read_payload, 9L);
    ply_set_read_cb(ply, "vertex", "rot_1", &loader_ply_read_callback, &read_payload, 10L);
    ply_set_read_cb(ply, "vertex", "rot_2", &loader_ply_read_callback, &read_payload, 11L);
    ply_set_read_cb(ply, "vertex", "rot_3", &loader_ply_read_callback, &read_payload, 12L);
    ply_set_read_cb(ply, "vertex", "opacity", &loader_ply_read_callback, &read_payload, 13L);
