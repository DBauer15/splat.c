...
static tpool_work *
tpool_work_create(thread_func_t func, void *arg) {
  tpool_work *work;
...
static void
tpool_work_destroy(tpool_work *work) {
  if (work == NULL) return;
  free(work);
}

static tpool_work *
tpool_work_get(tpool *tm) {
  tpool_work *work;
...
int
tpool_add_work(tpool *tm, thread_func_t func, void *arg) {
  tpool_work *work;
